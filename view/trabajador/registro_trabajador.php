            ...
            <form class="form-horizontal" id="formulario_trabajador">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="nombre_trabajador" onkeypress="return solo_letras(event);" class="form-control validacion" value="" id="nombre_trabajador" placeholder="nombres" maxlength="40">
                  </div>
                  <label  class="col-sm-2 control-label">DNI</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control validacion" onkeypress="return solo_numeros(event);" name="dni_trabajador" value="" id="dni_trabajador" maxlength="8" size="8" placeholder="DNI">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control validacion" name="apep_trabajador" value="" onkeypress="return solo_letras(event);" id="apep_trabajador" maxlength="40"  placeholder="apellido paterno">
                  </div>
                  <label  class="col-sm-2 control-label">Ape Materno</label>

                  <div class="col-sm-4">
                    <input type="text" class="form-control validacion" name="apem_trabajador" value="" onkeypress="return solo_letras(event);" id="apem_trabajador" maxlength="40" placeholder="apellido materno">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea name="domicilio_trabajador" placeholder="domicilio"  style="resize: vertical;"  class="form-control validacion" id="domicilio_trabajador" maxlength="240" cols="3" rows="3"></textarea>
                  </div>
                  <label  class="col-sm-2 control-label">Teléfono</label>

                  <div class="col-sm-3">
                    <input type="text" name="telefono_trabajador" onkeypress="return solo_numeros(event);" class="form-control validacion" value="" maxlength="20" id="telefono_trabajador" placeholder="telefono">
                  </div>
                </div>
                <div class="form-group">
                ...
                <label  class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-4">
                    <input type="email" name="email_trabajador" class="form-control validacion"  value="" id="email_trabajador" placeholder="email" maxlength="50">
