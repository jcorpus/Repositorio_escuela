            ...
            <form class="form-horizontal" id="formulario_alumno">
              <div class="box-body">
                ...
                <div class="alert alert-success alert-dismissible" style="display:none" id="correcto">
                    ...
                    Alumno Registrado Correctamente &nbsp;<i class="icon fa fa-check"></i>
                </div>
                <!--Mensaje de registro-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="telefono_alumno" class="form-control" value="767675" id="telefono_alumno" placeholder="telefono">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <label class="miradio ">
                      <input type="radio" id="masculino" class="form-control sexo"  name="sexo_alumno" value="M" checked>
                      <span> Masculino </span>
                    </label>
                    <label class="miradio ">
                      <input type="radio" id="femenino" class="form-control sexo"  name="sexo_alumno" value="F">
                      <span>Femenino </span>
                    </label>
                  </div>
                </div>
